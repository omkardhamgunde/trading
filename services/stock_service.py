...
ADDITIONAL_INDIAN_MID_SMALL_CAPS = {
    'AHLUCONT': ('Ahluwalia Contracts India', 'AHLUCONT.NS'),
    'AIAENG': ('AIA Engineering', 'AIAENG.NS'),
    'AETHER': ('Aether Industries', 'AETHER.NS'),
    'AKZOINDIA': ('Akzo Nobel India', 'AKZOINDIA.NS'),
    'ALEMBICLTD': ('Alembic', 'ALEMBICLTD.NS'),
    'ALKALI': ('Alkali Metals', 'ALKALI.NS'),
    'ALLCARGO': ('Allcargo Logistics', 'ALLCARGO.NS'),
    'AMIORG': ('Ami Organics', 'AMIORG.NS'),
    'ANANDRATHI': ('Anand Rathi Wealth', 'ANANDRATHI.NS'),
    'APARINDS': ('Apar Industries', 'APARINDS.NS'),
    'APOLLOPIPE': ('Apollo Pipes', 'APOLLOPIPE.NS'),
    'ASAHIINDIA': ('Asahi India Glass', 'ASAHIINDIA.NS'),
    'ASHOKA': ('Ashoka Buildcon', 'ASHOKA.NS'),
    'ASIANTILES': ('Asian Granito India', 'ASIANTILES.NS'),
    'ASTEC': ('Astec Lifesciences', 'ASTEC.NS'),
    'AUTOAXLES': ('Automotive Axles', 'AUTOAXLES.NS'),
    'AVTNPL': ('AVT Natural Products', 'AVTNPL.NS'),
    'BAJAJELEC': ('Bajaj Electricals', 'BAJAJELEC.NS'),
    'BALAMINES': ('Balaji Amines', 'BALAMINES.NS'),
    'BALRAMCHIN': ('Balrampur Chini Mills', 'BALRAMCHIN.NS'),
    'BANCOINDIA': ('Banco Products India', 'BANCOINDIA.NS'),
    'BARBEQUE': ('Barbeque Nation Hospitality', 'BARBEQUE.NS'),
    'BBOX': ('Black Box', 'BBOX.NS'),
    'BEML': ('BEML', 'BEML.NS'),
    'BEPL': ('Bhansali Engineering Polymers', 'BEPL.NS'),
    'BLS': ('BLS International Services', 'BLS.NS'),
    'BSOFT': ('Birlasoft', 'BSOFT.NS'),
    'BUTTERFLY': ('Butterfly Gandhimathi Appliances', 'BUTTERFLY.NS'),
    'CAPLIPOINT': ('Caplin Point Laboratories', 'CAPLIPOINT.NS'),
    'CARYSIL': ('Carysil', 'CARYSIL.NS'),
    'CCL': ('CCL Products India', 'CCL.NS'),
    'CEATLTD': ('CEAT', 'CEATLTD.NS'),
    'CENTUM': ('Centum Electronics', 'CENTUM.NS'),
    'CERA': ('Cera Sanitaryware', 'CERA.NS'),
    'CHEMPLASTS': ('Chemplast Sanmar', 'CHEMPLASTS.NS'),
    'CHOICEIN': ('Choice International', 'CHOICEIN.NS'),
    'CIEINDIA': ('CIE Automotive India', 'CIEINDIA.NS'),
    'CONTROLPR': ('Control Print', 'CONTROLPR.NS'),
    'CRAFTSMAN': ('Craftsman Automation', 'CRAFTSMAN.NS'),
    'CREDITACC': ('CreditAccess Grameen', 'CREDITACC.NS'),
    'CSBBANK': ('CSB Bank', 'CSBBANK.NS'),
    'DCBBANK': ('DCB Bank', 'DCBBANK.NS'),
    'DCXINDIA': ('DCX Systems', 'DCXINDIA.NS'),
    'DOLLAR': ('Dollar Industries', 'DOLLAR.NS'),
    'DREDGECORP': ('Dredging Corporation of India', 'DREDGECORP.NS'),
    'EASEMYTRIP': ('Easy Trip Planners', 'EASEMYTRIP.NS'),
    'ELECON': ('Elecon Engineering', 'ELECON.NS'),
    'ELECTCAST': ('Electrosteel Castings', 'ELECTCAST.NS'),
    'ELGIEQUIP': ('Elgi Equipments', 'ELGIEQUIP.NS'),
    'EMIL': ('Electronics Mart India', 'EMIL.NS'),
    'EQUITASBNK': ('Equitas Small Finance Bank', 'EQUITASBNK.NS'),
    'ERIS': ('Eris Lifesciences', 'ERIS.NS'),
    'ETHOSLTD': ('Ethos', 'ETHOSLTD.NS'),
    'FEDFINA': ('Fedbank Financial Services', 'FEDFINA.NS'),
    'FIEMIND': ('Fiem Industries', 'FIEMIND.NS'),
    'FINCABLES': ('Finolex Cables', 'FINCABLES.NS'),
    'FINPIPE': ('Finolex Industries', 'FINPIPE.NS'),
    'FIVESTAR': ('Five-Star Business Finance', 'FIVESTAR.NS'),
    'GABRIEL': ('Gabriel India', 'GABRIEL.NS'),
    'GATEWAY': ('Gateway Distriparks', 'GATEWAY.NS'),
    'GEOJITFSL': ('Geojit Financial Services', 'GEOJITFSL.NS'),
    'GEPIL': ('GE Power India', 'GEPIL.NS'),
    'GMDCLTD': ('Gujarat Mineral Development Corporation', 'GMDCLTD.NS'),
    'GMRP&UI': ('GMR Power and Urban Infra', 'GMRP&UI.NS'),
    'GOCOLORS': ('Go Fashion India', 'GOCOLORS.NS'),
    'GOKEX': ('Gokaldas Exports', 'GOKEX.NS'),
    'GOODLUCK': ('Goodluck India', 'GOODLUCK.NS'),
    'GRANULES': ('Granules India', 'GRANULES.NS'),
    'GREENPANEL': ('Greenpanel Industries', 'GREENPANEL.NS'),
    'GREENPLY': ('Greenply Industries', 'GREENPLY.NS'),
    'GRSE': ('Garden Reach Shipbuilders and Engineers', 'GRSE.NS'),
    'GTPL': ('GTPL Hathway', 'GTPL.NS'),
    'HAPPSTMNDS': ('Happiest Minds Technologies', 'HAPPSTMNDS.NS'),
    'HBLENGINE': ('HBL Engineering', 'HBLENGINE.NS'),
    'HEG': ('HEG', 'HEG.NS'),
    'HEIDELBERG': ('HeidelbergCement India', 'HEIDELBERG.NS'),
    'HERITGFOOD': ('Heritage Foods', 'HERITGFOOD.NS'),
    'HFCL': ('HFCL', 'HFCL.NS'),
    'HGINFRA': ('HG Infra Engineering', 'HGINFRA.NS'),
    'HIKAL': ('Hikal', 'HIKAL.NS'),
    'HIMATSEIDE': ('Himatsingka Seide', 'HIMATSEIDE.NS'),
    'HLEGLAS': ('HLE Glascoat', 'HLEGLAS.NS'),
    'HONAUT': ('Honeywell Automation India', 'HONAUT.NS'),
    'HUHTAMAKI': ('Huhtamaki India', 'HUHTAMAKI.NS'),
    'IBREALEST': ('Indiabulls Real Estate', 'IBREALEST.NS'),
    'ICIL': ('Indo Count Industries', 'ICIL.NS'),
    'IDEAFORGE': ('ideaForge Technology', 'IDEAFORGE.NS'),
    'IFBIND': ('IFB Industries', 'IFBIND.NS'),
    'IIFLSEC': ('IIFL Securities', 'IIFLSEC.NS'),
    'IKIO': ('IKIO Lighting', 'IKIO.NS'),
    'INDIGOPNTS': ('Indigo Paints', 'INDIGOPNTS.NS'),
    'INDOSTAR': ('IndoStar Capital Finance', 'INDOSTAR.NS'),
    'INFIBEAM': ('Infibeam Avenues', 'INFIBEAM.NS'),
    'INGERRAND': ('Ingersoll Rand India', 'INGERRAND.NS'),
    'IONEXCHANG': ('Ion Exchange India', 'IONEXCHANG.NS'),
    'ISGEC': ('ISGEC Heavy Engineering', 'ISGEC.NS'),
    'ITDC': ('India Tourism Development Corp', 'ITDC.NS'),
    'JAGRAN': ('Jagran Prakashan', 'JAGRAN.NS'),
    'JAMNAAUTO': ('Jamna Auto Industries', 'JAMNAAUTO.NS'),
    'JINDWORLD': ('Jindal Worldwide', 'JINDWORLD.NS'),
    'JISLJALEQS': ('Jain Irrigation Systems', 'JISLJALEQS.NS'),
    'JKIL': ('J Kumar Infraprojects', 'JKIL.NS'),
    'JKPAPER': ('JK Paper', 'JKPAPER.NS'),
    'JTEKTINDIA': ('JTEKT India', 'JTEKTINDIA.NS'),
    'JUSTDIAL': ('Just Dial', 'JUSTDIAL.NS'),
    'KCP': ('KCP', 'KCP.NS'),
    'KIRLOSBROS': ('Kirloskar Brothers', 'KIRLOSBROS.NS'),
    'KIRLOSENG': ('Kirloskar Oil Engines', 'KIRLOSENG.NS'),
    'KIRLPNU': ('Kirloskar Pneumatic', 'KIRLPNU.NS'),
    'KSB': ('KSB', 'KSB.NS'),
    'LATENTVIEW': ('Latent View Analytics', 'LATENTVIEW.NS'),
    'LTFOODS': ('LT Foods', 'LTFOODS.NS'),
    'LUMAXIND': ('Lumax Industries', 'LUMAXIND.NS'),
    'LUXIND': ('Lux Industries', 'LUXIND.NS'),
    'LXCHEM': ('Laxmi Organic Industries', 'LXCHEM.NS'),
    'MAHLOG': ('Mahindra Logistics', 'MAHLOG.NS'),
    'MARKSANS': ('Marksans Pharma', 'MARKSANS.NS'),
    'MATRIMONY': ('Matrimony.com', 'MATRIMONY.NS'),
    'MAYURUNIQ': ('Mayur Uniquoters', 'MAYURUNIQ.NS'),
    'MEDPLUS': ('MedPlus Health Services', 'MEDPLUS.NS'),
    'MOLDTKPAC': ('Mold-Tek Packaging', 'MOLDTKPAC.NS'),
    'MONTECARLO': ('Monte Carlo Fashions', 'MONTECARLO.NS'),
    'MOREPENLAB': ('Morepen Laboratories', 'MOREPENLAB.NS'),
    'MSTCLTD': ('MSTC', 'MSTCLTD.NS'),
    'MTARTECH': ('MTAR Technologies', 'MTARTECH.NS'),
    'MUFTI': ('Credo Brands Marketing', 'MUFTI.NS'),
    'MUKANDLTD': ('Mukand', 'MUKANDLTD.NS'),
    'NAVA': ('Nava', 'NAVA.NS'),
    'NEOGEN': ('Neogen Chemicals', 'NEOGEN.NS'),
    'NETWORK18': ('Network18 Media and Investments', 'NETWORK18.NS'),
    'NFL': ('National Fertilizers', 'NFL.NS'),
    'NILKAMAL': ('Nilkamal', 'NILKAMAL.NS'),
    'NUCLEUS': ('Nucleus Software Exports', 'NUCLEUS.NS'),
    'ORCHPHARMA': ('Orchid Pharma', 'ORCHPHARMA.NS'),
    'ORIENTCEM': ('Orient Cement', 'ORIENTCEM.NS'),
    'PAISALO': ('Paisalo Digital', 'PAISALO.NS'),
    'PANAMAPET': ('Panama Petrochem', 'PANAMAPET.NS'),
    'PARADEEP': ('Paradeep Phosphates', 'PARADEEP.NS'),
    'PARKHOTELS': ('Apeejay Surrendra Park Hotels', 'PARKHOTELS.NS'),
    'PCBL': ('PCBL', 'PCBL.NS'),
    'PDSL': ('PDS', 'PDSL.NS'),
    'PFS': ('PTC India Financial Services', 'PFS.NS'),
    'PGEL': ('PG Electroplast', 'PGEL.NS'),
    'PILANIINVS': ('Pilani Investment and Industries', 'PILANIINVS.NS'),
    'PNBHOUSING': ('PNB Housing Finance', 'PNBHOUSING.NS'),
    'POWERMECH': ('Power Mech Projects', 'POWERMECH.NS'),
    'PRSMJOHNSN': ('Prism Johnson', 'PRSMJOHNSN.NS'),
    'PTC': ('PTC India', 'PTC.NS'),
    'RALLIS': ('Rallis India', 'RALLIS.NS'),
    'RAYMONDLSL': ('Raymond Lifestyle', 'RAYMONDLSL.NS'),
    'RELAXO': ('Relaxo Footwears', 'RELAXO.NS'),
    'ROSSARI': ('Rossari Biotech', 'ROSSARI.NS'),
    'RPGLIFE': ('RPG Life Sciences', 'RPGLIFE.NS'),
    'RSYSTEMS': ('R Systems International', 'RSYSTEMS.NS'),
    'SAREGAMA': ('Saregama India', 'SAREGAMA.NS'),
    'SBFC': ('SBFC Finance', 'SBFC.NS'),
    'SBICARD': ('SBI Cards and Payment Services', 'SBICARD.NS'),
    'SFL': ('Sheela Foam', 'SFL.NS'),
    'SHARDACROP': ('Sharda Cropchem', 'SHARDACROP.NS'),
    'SHILPAMED': ('Shilpa Medicare', 'SHILPAMED.NS'),
    'SHOPERSTOP': ('Shoppers Stop', 'SHOPERSTOP.NS'),
    'SIYSIL': ('Siyaram Silk Mills', 'SIYSIL.NS'),
    'SOUTHBANK': ('South Indian Bank', 'SOUTHBANK.NS'),
    'SPARC': ('Sun Pharma Advanced Research Company', 'SPARC.NS'),
    'SPANDANA': ('Spandana Sphoorty Financial', 'SPANDANA.NS'),
    'STARCEMENT': ('Star Cement', 'STARCEMENT.NS'),
    'STLTECH': ('Sterlite Technologies', 'STLTECH.NS'),
    'SUBROS': ('Subros', 'SUBROS.NS'),
    'SUDARSCHEM': ('Sudarshan Chemical Industries', 'SUDARSCHEM.NS'),
    'SUMICHEM': ('Sumitomo Chemical India', 'SUMICHEM.NS'),
    'SURYAROSNI': ('Surya Roshni', 'SURYAROSNI.NS'),
    'TARC': ('TARC', 'TARC.NS'),
    'TCI': ('Transport Corporation of India', 'TCI.NS'),
    'TCIEXP': ('TCI Express', 'TCIEXP.NS'),
    'TCNSBRANDS': ('TCNS Clothing', 'TCNSBRANDS.NS'),
    'TEJASNET': ('Tejas Networks', 'TEJASNET.NS'),
    'TEXRAIL': ('Texmaco Rail and Engineering', 'TEXRAIL.NS'),
    'THANGAMAYL': ('Thangamayil Jewellery', 'THANGAMAYL.NS'),
    'THERMAX': ('Thermax', 'THERMAX.NS'),
    'TMB': ('Tamilnad Mercantile Bank', 'TMB.NS'),
    'TRIVENI': ('Triveni Engineering and Industries', 'TRIVENI.NS'),
    'TTML': ('Tata Teleservices Maharashtra', 'TTML.NS'),
    'TV18BRDCST': ('TV18 Broadcast', 'TV18BRDCST.NS'),
    'TVSSCS': ('TVS Supply Chain Solutions', 'TVSSCS.NS'),
    'UJJIVAN': ('Ujjivan Financial Services', 'UJJIVAN.NS'),
    'USHAMART': ('Usha Martin', 'USHAMART.NS'),
    'VAKRANGEE': ('Vakrangee', 'VAKRANGEE.NS'),
    'VGUARD': ('V-Guard Industries', 'VGUARD.NS'),
    'WABAG': ('VA Tech Wabag', 'WABAG.NS'),
    'WELCORP': ('Welspun Corp', 'WELCORP.NS'),
    'WONDERLA': ('Wonderla Holidays', 'WONDERLA.NS'),
    'ZAGGLE': ('Zaggle Prepaid Ocean Services', 'ZAGGLE.NS'),
}

STOCKS['india']['equity'].update(ADDITIONAL_INDIAN_EQUITIES)
STOCKS['india']['equity'].update(ADDITIONAL_INDIAN_MID_SMALL_CAPS)
